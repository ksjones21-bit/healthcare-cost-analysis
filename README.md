...
## Key Analysis Steps
- Cleaned and structured hospital billing dataset
- Analyzed average billing amounts by medical condition
- Evaluated cost variation by admission type and insurance provider
- Explored length of stay as a potential cost driver
